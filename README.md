...
```sh
git clone git@github.com:shz0116/learnchisel.git
cd learnchisel
```
...
#### Commit your changes
```sh
git commit -m 'Starting learnchisel'
...
============Learning CHisel Using Windows WSL2=========================================
1. Installation
...
curl -sL "https://keyserver.ubuntu.com/pks/lookup?op=get&search=0x2EE0EA64E40A89B84B2DF73499E82A75642AC823" | sudo -H gpg --no-default-keyring --keyring gnupg-ring:/etc/apt/trusted.gpg.d/scalasbt-release.gpg --import sudo chmod 644 /etc/apt/trusted.gpg.d/scalasbt-release.gpg
sudo apt-get update  
sudo apt-get install sbt                        
sudo apt-get install verilator

2. Clone the Template
git clone https://github.com/shz0116/learnchisel.git
